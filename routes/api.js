...
var kuhong = db.get('ojan'); // jan diubah
	...
	console.log('WELCOME TO KAGURASEC API!') // boleh diubah
}

var creatorList = ['KaguraSec']; // Nama Lu Ngab
var creator = creatorList[Math.floor(Math.random() * creatorList.length)]; // Ini jan diubah
var key = 'KaguraSec' // Apikey Lu Ngab
...
router.get('/nsfwass', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
           type = req.query.type 
    ...
    if (!type) return res.json({ status : false, creator : `${creator}`, message : "Masukan parameter type"})
       ...
       fetch(encodeURI(`https://raku-web.herokuapp.com/api/nsfw/ass?apikey=RakuKeyTod=${type}`))
        .then(response => response.json())
        .then(data => {
        var result = data;
             res.json({
...
try {
  ...
  if (!url) return res.json(loghandler.noturl)
     ...
     var hasil = await getBuffer(`https://api.dapuhy.ga/api/maker/foliokanan?text=${url}&apikey=Alphabot`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.me/api/splaybutton?apikey=apivinz&text=${text}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.me/api/gplaybutton?apikey=apivinz&text=${text}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
router.get('/watercolor', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
	    text1 = req.query.text1;
	    text2 = req.query.text2;
try {
  ...
  if (!text1) return res.json(loghandler.nottext)
   if (!text2) return res.json(loghandler.nottext2)
     var hasil = await getBuffer(`https://api.zeks.me/api/watercolour?apikey=apivinz&text1=${text}&text2=${text2}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.me/api/tfire?apikey=apivinz&text=${text}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
router.get('/sandw', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
	    text = req.query.text;
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.me/api/sandw?apikey=apivinz&text=${text}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
router.get('/logoepep', async (req, res, next) => {
        var apikeyInput = req.query.apikey,
	    text = req.query.text;
...
try {
  ...
  if (!text) return res.json(loghandler.nottext)
     ...
     var hasil = await getBuffer(`https://api.zeks.me/api/epep?apikey=apivinz&text=${text}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
...
try {
  ...
  if (!text1) return res.json(loghandler.nottext)
   if (!text2) return res.json(loghandler.nottext2)
     ...
     var hasil = await getBuffer(`https://api.zeks.me/api/phlogo?apikey=apivinz&text1=${text1}&text2=${text2}`)
       await fs.writeFileSync(__path + '/tmp/screenshot.png', hasil)
